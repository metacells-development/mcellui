...
- input.tsx (line ~400): padding: 4 -> spacing[1], borderRadius stays (handled in Plan 02)
- checkbox.tsx (line ~247): gap: 2 -> spacing[0.5]
- radio-group.tsx (lines ~255, 260, 268): gap: 12 -> spacing[3], gap: 10 -> spacing[2.5], marginTop: 2 -> spacing[0.5]
- switch.tsx (line ~232): gap: 2 -> spacing[0.5]
...
Files and specific changes:
- alert.tsx (lines ~285, 289, 299): marginTop: 2 -> spacing[0.5], gap: 4 -> spacing[1], padding: 4 -> spacing[1]
- chip.tsx (lines ~220, 250, 298): marginRight: 6 -> spacing[1.5], marginLeft: 4 -> spacing[1], padding: 2 -> spacing[0.5]
- search-input.tsx (lines ~276, 277): padding: 0, margin: 0 -> keep as 0 (no change needed)
- section-header.tsx (line ~253): gap: 2 -> spacing[0.5]
