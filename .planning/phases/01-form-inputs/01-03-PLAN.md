...
<objective>
Migrate Slider, Stepper, Radio, and TagInput from local token definitions to centralized design tokens.
...
Output: All four components using components.ts tokens with no local size definitions.
</objective>
